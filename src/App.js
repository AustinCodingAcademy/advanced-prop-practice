...
function App(props) {
  ...
  return (
    <div>
      ...
      <div>This better say "Goodbye World": <SuperComponent
      message={"Goodbye World"} /> </div>
      ...
      <div>This better say "Hand Sanitizer": <SuperComponent
      products={props.products} /> </div>
