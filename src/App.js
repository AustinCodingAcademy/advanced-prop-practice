...
function App(props) {
  ...
  let array1 = ["Brodie","Alicia","Margo"];
  let array2 = ["Titus","Axel","Claire"];
  ...
  return (
    <div>
      ...
      <div>This better say "Goodbye World": <SuperComponent message={"Goodbuye World"}/> </div>
      ...
      <div>This better say "Brodie, Alicia, Margo" : <SuperComponent names={array1}/> </div>
      {/* send in a prop called "names", give it an array ["Titus","Axel","Claire"]*/}
      <div>This better say "Titus, Axel, Claire" : <SuperComponent names={array2}/> </div>
