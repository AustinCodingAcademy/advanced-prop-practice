...
function App(props) {
  ...
  const namesTwo = ["Brodie","Alicia","Margo"];
  const namesThree = ["Titus","Axel","Claire"];
  return (
    <div>
      ...
      <div>This better say "pepsi": <SuperComponent product={productTwo} /> </div>
      {/* send in a prop called "product", give it an object with a name property "nike"*/}
      <div>This better say "nike": <SuperComponent product={productThree}/> </div>
      ...
      <div>This better say "Brodie, Alicia, Margo" : <SuperComponent names={namesTwo}/> </div>
      {/* send in a prop called "names", give it an array ["Titus","Axel","Claire"]*/}
      <div>This better say "Titus, Axel, Claire" : <SuperComponent names={namesThree}/> </div>
